...
class Square {
  ...
  factory Square.fromMap(Map<String, dynamic> json) => Square(
    square: json["square"] == null ? null : List<SquareElement>.from(json["square"].map((x) => SquareElement.fromMap(x))),
  );

  Map<String, dynamic> toMap() => {
    "square": square == null ? null : List<dynamic>.from(square.map((x) => x.toMap())),
  };
}
...
class SquareElement {
  ...
  factory SquareElement.fromJson(String str) => SquareElement.fromMap(json.decode(str));
  ...
  factory SquareElement.fromMap(Map<String, dynamic> json) => SquareElement(
    ...
    allowForking: json["allow_forking"] == null ? null : json["allow_forking"],
